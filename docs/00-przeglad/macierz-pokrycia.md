...
- Stan na **2026-09-20**. Identyfikatory zadań są wypisane w całości, bez skracania do „(+N)”. Macierz wygenerowano skryptem z trzech źródeł: tabel [`wymagania.md`](wymagania.md), zadań z [`../08-plan/backlog.md`](../08-plan/backlog.md) (kolumna „Wymagania”) i wystąpień identyfikatorów w dokumentach projektowych (`docs/` bez planu i specyfikacji, razem z `openapi.yaml` i `schema.sql`; zakresy typu „FR-04.02–FR-04.09” są rozwijane).
...
- Lokalna kontrola bez zależności: `node scripts/check-docs.mjs`; testy: `node --test scripts/check-docs.test.mjs`. Sprawdza pełne przypisania FR/NFR ↔ BL w tabelach, lokalne linki plikowe Markdown (również referencyjne) i pierwsze zdanie „Cel:” dokumentów Markdown w `docs/`, dokumentów głównych oraz instrukcji README w `.github/`. Ignoruje przykłady w blokach kodu; nie sprawdza zdalnych URL ani kotwic nagłówków. BL-708 pozostaje jawną propozycją bez FR/NFR (`—` w backlogu), obecną w rejestrze luk G-12; test nie przypisuje mu sztucznie wymagania. Podłączenie do CI jest obecnie nieaktywnym szkicem.
...
| FR-07.12 | Dokumenty prawne i zgody: przy rejestracji akceptacja regulaminu i … | P0 | [openapi.yaml](../02-api/openapi.yaml), [mapa-ekranow](../04-frontend/mapa-ekranow.md), [uwierzytelnianie-autoryzacja](../06-bezpieczenstwo/uwierzytelnianie-autoryzacja.md) (+5) | BL-102, BL-104, BL-116, BL-122, BL-123, BL-124, BL-156 | M1 | ✅ |
...
| NFR-02.02 | Moduły funkcjonalne mają własne API (prefiks), model domenowy, tabele … | P0 | [przeglad-architektury](../01-architektura/przeglad-architektury.md), [ADR-002](../09-decyzje/ADR-002-monorepo.md), [ADR-006](../09-decyzje/ADR-006-panel-administratora.md) (+1) | BL-002, BL-004, BL-006, BL-017, BL-117 | M0, M1 | ✅ |
...
| NFR-03.06 | TLS 1.3, HSTS, CSP bez `unsafe-inline` (nonce), `frame-ancestors` … | P0 | [kontrole-bezpieczenstwa](../06-bezpieczenstwo/kontrole-bezpieczenstwa.md), [architektura-ui](../04-frontend/architektura-ui.md), [ADR-011](../09-decyzje/ADR-011-topologia-wdrozenia.md) | BL-011, BL-025, BL-156, BL-602, BL-603 | M0, M1, M6 | ✅ |
...
| NFR-03.09 | Łańcuch dostaw: lockfile i pinowanie, Renovate/Dependabot, SCA (osv-scanner) … | P1 | [kontrole-bezpieczenstwa](../06-bezpieczenstwo/kontrole-bezpieczenstwa.md), [ci-cd](../07-wdrozenie/ci-cd.md), [ADR-013](../09-decyzje/ADR-013-repozytorium-publiczne.md) | BL-001, BL-017, BL-019, BL-021, BL-608, BL-612 | M0, M6 | ✅ |
...
| NFR-03.11 | Hardening: firewall (domyślnie deny), CrowdSec, SSH wyłącznie kluczami … | P0 | [infrastruktura](../07-wdrozenie/infrastruktura.md), [kontrole-bezpieczenstwa](../06-bezpieczenstwo/kontrole-bezpieczenstwa.md), [ADR-011](../09-decyzje/ADR-011-topologia-wdrozenia.md) | BL-020, BL-022, BL-023, BL-024, BL-025, BL-026, BL-027, BL-151 | M0, M1 | ✅ |
...
| NFR-08.02 | Każdy wzór z `obliczenia-finansowe.md` ma testy na wektorach referencyjnych z … | P0 | [ADR-003](../09-decyzje/ADR-003-hybryda-obliczen-i-kolejki.md), [ADR-014](../09-decyzje/ADR-014-pieniadze-waluty-czas.md) | BL-015, BL-142, BL-201, BL-301, BL-317 | M0, M1, M2, M3 | ✅ |
...
| NFR-09.04 | Monitoring: health-checki, metryki, logi strukturalne JSON z identyfikatorem … | P1 | [monitoring](../07-wdrozenie/monitoring.md) | BL-006, BL-009, BL-013, BL-029, BL-152 | M0, M1 | ✅ |
