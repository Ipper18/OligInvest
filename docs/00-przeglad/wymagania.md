...
| FR-07.08 | Profil i preferencje: waluta bazowa (domyślnie PLN), metoda cost basis, ustawienia widoku podatkowego (dzień przychodu, koszt przewalutowania), strefa czasowa, język, motyw (jasny/ciemny/systemowy), paleta zysk/strata przyjazna daltonistom. | P1 | Zmiana palety działa globalnie bez przeładowania; preferencje synchronizowane między urządzeniami. | 3.2 |
